    ...
    <section id="contact" ref={ref} className="section section--alt ct-section">
      <div className="container">
        ...
        <div className={`ct-download${visible ? ' ct-in ct-in--d4' : ''}`}>
          <a href="/kaylee-schneider-cv.pdf" target="_blank" rel="noopener noreferrer" className="ct-dl-btn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
              <polyline points="7 10 12 15 17 10"/>
              <line x1="12" y1="15" x2="12" y2="3"/>
            </svg>
            Download Receptionist / Admin CV
          </a>
          <p className="ct-dl-note">Johannesburg, South Africa &middot; Open to remote opportunities</p>
        </div>
